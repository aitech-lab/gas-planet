...
init_gui = function() {
  ...
  t.add(params, 'u_fbm4_1', -1.0, 1.0, 0.0001).onChange(function(v) {
    return material.uniforms.u_fbm4_1.value = v;
  });
  t.add(params, 'u_fbm4_2', -1.0, 1.0, 0.0001).onChange(function(v) {
    return material.uniforms.u_fbm4_2.value = v;
  });
  t.add(params, 'u_fbm4_3', -1.0, 1.0, 0.0001).onChange(function(v) {
    return material.uniforms.u_fbm4_3.value = v;
  });
  t.add(params, 'u_fbm4_4', -1.0, 1.0, 0.0001).onChange(function(v) {
    return material.uniforms.u_fbm4_4.value = v;
  });
  t = gui.addFolder("FBM6");
  t.add(params, 'u_fbm6_1', -1.0, 1.0, 0.0001).onChange(function(v) {
    return material.uniforms.u_fbm6_1.value = v;
  });
  t.add(params, 'u_fbm6_2', -1.0, 1.0, 0.0001).onChange(function(v) {
    return material.uniforms.u_fbm6_2.value = v;
  });
  t.add(params, 'u_fbm6_3', -1.0, 1.0, 0.0001).onChange(function(v) {
    return material.uniforms.u_fbm6_3.value = v;
  });
  t.add(params, 'u_fbm6_4', -1.0, 1.0, 0.0001).onChange(function(v) {
    return material.uniforms.u_fbm6_4.value = v;
  });
  t.add(params, 'u_fbm6_5', -1.0, 1.0, 0.0001).onChange(function(v) {
    return material.uniforms.u_fbm6_5.value = v;
  });
  t.add(params, 'u_fbm6_6', -1.0, 1.0, 0.0001).onChange(function(v) {
    return material.uniforms.u_fbm6_6.value = v;
  });
