...
var animate, camera, clock, container, ctx, current_material, cvs, draw_spot, generate_planet_texture, init, init_gui, init_materilas, init_planet_texture, input, materials, materials_cnt, onWindowResize, p2u, params, planet, planet_details, planet_radius, planet_resolution, pr_h, pr_w, render, renderer, rnd, scene, seed, shader_load, stats, text_load, time, velocities;
...
init = function() {
  ...
  velocities.value.needsUpdate = true;
  shader_load("planet").then(function(shaders) {
